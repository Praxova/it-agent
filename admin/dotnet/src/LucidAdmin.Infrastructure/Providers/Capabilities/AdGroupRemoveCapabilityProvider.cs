...
public class AdGroupRemoveCapabilityProvider : BaseCapabilityProvider
{
    public override string CapabilityId => "ad-group-remove";
    public override string Version => "1.0.0";
    public override string Category => "active-directory";
    public override string DisplayName => "AD Group Remove Member";
    public override string Description => "Remove users from Active Directory groups";
