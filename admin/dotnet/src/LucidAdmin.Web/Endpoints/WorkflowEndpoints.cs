    ...
    public static void MapWorkflowEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/step-types", () =>
        {
            var stepTypes = new List<StepTypeInfo>
            {
                ...
                new(StepType.Approval, "Approval", "Human approval checkpoint with auto-approve threshold", "✋", "#FF8F00", 1, 2),
                new(StepType.Clarify, "Clarify", "Ask user a clarifying question and wait for reply", "❓", "#FF6F00", 1, 2)
            };
